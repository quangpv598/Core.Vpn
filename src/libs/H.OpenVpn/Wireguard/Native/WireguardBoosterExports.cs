...
namespace H.OpenVpn.Wireguard.Native;
internal static class WireguardBoosterExports
{
    ...
    public static extern nint wgb_get_handle(LogPrinter logPrinter, WgbLogLevel level, bool enableTrafficCapture);

    [DllImport("wgbooster.dll", CallingConvention = CallingConvention.StdCall)]
    public static extern void wgb_set_log_level(nint wgboosterHandle, WgbLogLevel level);

    [DllImport("wgbooster.dll", CallingConvention = CallingConvention.StdCall)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool wgb_create_tunnel_from_file(nint wgboosterHandle,
        [MarshalAs(UnmanagedType.LPStr)] string fileName);

    [DllImport("wgbooster.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Unicode)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool wgb_create_tunnel_from_file_w(nint wgboosterHandle,
        [MarshalAs(UnmanagedType.LPWStr)] string fileName);

    [DllImport("wgbooster.dll", CallingConvention = CallingConvention.StdCall)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool wgb_create_tunnel(nint wgboosterHandle, ref WgbInterface interfaceSettings,
        ref WgbPeer peerSettings, ref WgbExtra extra);

    [DllImport("wgbooster.dll", CallingConvention = CallingConvention.StdCall)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool wgb_drop_tunnel(nint wgboosterHandle);

    [DllImport("wgbooster.dll", CallingConvention = CallingConvention.StdCall)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool wgb_start_tunnel(nint wgboosterHandle);

    [DllImport("wgbooster.dll", CallingConvention = CallingConvention.StdCall)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool wgb_stop_tunnel(nint wgboosterHandle);

    [DllImport("wgbooster.dll", CallingConvention = CallingConvention.StdCall)]
    public static extern WgbStats wgb_get_tunnel_state(nint wgboosterHandle);

    [DllImport("wgbooster.dll", CallingConvention = CallingConvention.StdCall)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool wgb_get_tunnel_active(nint wgboosterHandle);
    ...
    [DllImport("wgbooster.dll", CallingConvention = CallingConvention.StdCall)]
    public static extern void wgbp_set_log_level(nint wgboosterHandle, WgbLogLevel level);

    [DllImport("wgbooster.dll", CallingConvention = CallingConvention.StdCall)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool wgbp_create_tunnel_from_file(nint wgboosterHandle,
        [MarshalAs(UnmanagedType.LPStr)] string fileName);

    [DllImport("wgbooster.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Unicode)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool wgbp_create_tunnel_from_file_w(nint wgboosterHandle,
        [MarshalAs(UnmanagedType.LPWStr)] string fileName);

    [DllImport("wgbooster.dll", CallingConvention = CallingConvention.StdCall)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool wgbp_create_tunnel(nint wgboosterHandle, ref WgbInterface interfaceSettings,
        ref WgbPeer peerSettings, ref WgbExtra extra);

    [DllImport("wgbooster.dll", CallingConvention = CallingConvention.StdCall)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool wgbp_drop_tunnel(nint wgboosterHandle);

    [DllImport("wgbooster.dll", CallingConvention = CallingConvention.StdCall)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool wgbp_start_tunnel(nint wgboosterHandle);

    [DllImport("wgbooster.dll", CallingConvention = CallingConvention.StdCall)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool wgbp_stop_tunnel(nint wgboosterHandle);

    [DllImport("wgbooster.dll", CallingConvention = CallingConvention.StdCall)]
    public static extern WgbStats wgbp_get_tunnel_state(nint wgboosterHandle);

    [DllImport("wgbooster.dll", CallingConvention = CallingConvention.StdCall)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool wgbp_get_tunnel_active(nint wgboosterHandle);
